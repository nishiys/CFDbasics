...
waveSolver1d::waveSolver1d(Bounds calc_bounds, double endtime, int n_timestep,
                    int n_cells, double wave_velocity)
...
waveSolver1d::~waveSolver1d(){}

void waveSolver1d::writeFlowFile(std::string filename)
{
...
int main()
{
    ...
    /*--- Configure ---*/
    waveSolver1d flow(calc_bounds_, endtime, n_timestep, n_cells, wave_velocity);
